...
download "boost"     "https://dl.bintray.com/boostorg/release/1.71.0/source/boost_1_71_0.tar.gz"
...
download "wxWidgets" "https://github.com/wxWidgets/wxWidgets/releases/download/v3.1.3/wxWidgets-3.1.3.tar.bz2"
